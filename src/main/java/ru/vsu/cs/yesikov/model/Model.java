...
//                vertexNormals.put(vertexIndex, vertexNormals.getOrDefault(vertexIndex, new Vector3f(0, 0, 0)).plus(normal));
//            }
//        }
//
//        for (Map.Entry<Integer, Vector3f> entry : vertexNormals.entrySet()) {
//            Vector3f averageNormal = entry.getValue().getNormalized();
